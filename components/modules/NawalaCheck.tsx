...
import { Shield, ShieldCheck, ShieldAlert, Globe } from 'lucide-react';

export default function NawalaCheck({ showToast }: {
    ...
    <div className="max-w-2xl mx-auto py-10">
      <div className="glass-card p-10 rounded-3xl space-y-8 text-center border border-white/10">
        ...
        <div className="flex space-x-2">
          ...
          />
          <button onClick={check} className="bg-blue-600 px-8 rounded-2xl font-bold hover:bg-blue-500 transition-all">ANALYSIS</button>
        </div>
        {status !== 'IDLE' && (
